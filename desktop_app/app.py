...
DEFAULT_OUTPUT_DIR = Path.home() / "Documents" / APP_DIR_NAME / "output"
...
def load_runner() -> tuple[Path, Any]:
    from desktop_app.runner import DEFAULT_OUTPUT_DIR as runner_output_dir
    from desktop_app.runner import run_simulation

    return runner_output_dir, run_simulation
